...
return new class extends Migration
{
    ...
    {
        Schema::create('syarat_seminarmhs', function (Blueprint $table) {
            $table->id('id');
            ...
            $table->string('formulir'); // file formulir seminar
            $table->string('bukti_sks'); // file bukti SKS
            $table->string('bukti_spp'); // file SPP
            $table->string('bukti_kehadiran'); // file kehadiran seminar
    ...
    {
        Schema::dropIfExists('syarat_seminarmhs');
    }
};
