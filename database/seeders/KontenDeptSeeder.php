...
class KontenDeptSeeder extends Seeder
{
    ...
    {
        KontenDept::create([
            'id_user' => 1, // pastikan user id 1 ada di tabel users
            ...
            'kebijakanmutu' => 'Untuk mendukung pengembangan IPB sebagai perguruan tinggi yang memiliki daya saing tinggi dan berkompetisi secara sehat dengan perguruan tinggi lainnya di dunia untuk menjadi perguruan tinggi berskala internasional, kebijakan mutu DHHT mengacu pada kebijakan mutu Fakultas Kehutanan, yaitu:
                            ...
                            7. Menyediakan dan melaksanakan kegiatan pemeliharaan sarana dan prasarana yang memadai, serta mengkomunikasikan kebijakan mutu kepada para pengajar, pegawai, dan mahasiswa.
                            ...
                            3. Melakukan evaluasi bersama Ketua Departemen untuk tindakan korektif yang lebih dini terhadap pelaksanaan seluruh aktivitas penyelenggaraan akademik dan non akademik di lingkup kerjanya
                            4. Pengkoordinasian pembuatan laporan evaluasi diri mengikuti standar-standar dan parameter yang telah ditentukan.

                            GKM dibentuk melalui SK Dekan. Dalam implementasi sistem penjamin mutu, Kantor Manajemen Mutu (KMM), Gugus Penjamin Mutu (GPM), dan GKM berkoordinasi untuk mencapai sasaran mutu yang ditetapkan.'
        ]);
    }
}
