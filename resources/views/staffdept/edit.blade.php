        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Edit Staff Departemen</h2>
                </div>
                @if (session('info'))
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('staffdept.update', $staffDept->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        value="{{ old('nama', $staffDept->nama) }}" placeholder="Masukkan Nama Staff"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="jabatan" name="jabatan" class="form-control" id="jabatan"
                                        value="{{ old('jabatan', $staffDept->jabatan) }}" placeholder="Masukkan Jabatan"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" class="form-control" id="email"
                                        value="{{ old('email', $staffDept->email) }}" placeholder="Masukkan Email"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="website" class="form-control" id="website"
                                        ...
                                        placeholder="Masukkan link website pribadi">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="researchgate" class="form-control" id="researchgate"
                                        ...
                                        placeholder="Masukkan link ResearchGate">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="keahlian" class="form-control" id="keahlian" rows="3"
                                        placeholder="Masukkan bidang keahlian">{{ old('keahlian', $staffDept->keahlian) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="publikasi" class="form-control" id="publikasi" rows="3"
                                        placeholder="Masukkan link publikasi">{{ old('publikasi', $staffDept->publikasi ?? '') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="riwayat_pendidikan" class="form-control" id="riwayat_pendidikan" rows="3"
                                        placeholder="Masukkan riwayat pendidikan">{{ old('riwayat_pendidikan', $staffDept->riwayat_pendidikan) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="row">
                                    <div class="mb-3 d-flex justify-content-between align-items-center">
                                        <a href="{{ route('staffdept.index') }}"
                                            class="btn btn-secondary text-decoration-none">Kembali</a>
