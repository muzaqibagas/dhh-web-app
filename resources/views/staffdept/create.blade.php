                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('staffdept.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- {{-- NAMA --}} -->
                            <div class="row mb-3">
                                <label for="nama" class="col-sm-2 col-form-label text-start">Nama<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        value="{{ old('nama') }}" placeholder="Masukkan Nama Staff" required>
                                </div>
                            </div>

                            <!-- {{-- NIP --}} -->
                            <div class="row mb-3">
                                <label for="nip" class="col-sm-2 col-form-label text-start">NIP<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                            ...
                            <!-- {{-- FOTO --}} -->
                            <div class="row mb-3">
                                <label for="foto" class="col-sm-2 col-form-label text-start">Foto<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                                    <input type="file" name="foto" class="form-control" id="foto"
                                        accept="image/*" {{ old('foto') ? 'value=' . old('foto') : '' }} required>
                            ...
                            <!-- {{-- KATEGORI --}} -->
                            <div class="row mb-3">
                                <label for="kategori" class="col-sm-2 col-form-label text-start">Kategori<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                                    <select name="id_kategoristaff" id="kategori" class="form-select" required>
                                        ...
                                        @foreach ($kategoriStaffs as $kategori)
                                            <option value="{{ $kategori->id }}"
                                                {{ old('id_kategoristaff') == $kategori->id ? 'selected' : '' }}>
                            ...
                            <!-- {{-- DIVISI --}} -->
                            <div class="row mb-3">
                                <label for="divisi" class="col-sm-2 col-form-label text-start">Divisi<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                                    <select name="id_divisi" id="divisi" class="form-select" required>
                                        ...
                                        @foreach ($divisis as $divisi)
                                            <option value="{{ $divisi->id }}"
                                                {{ old('id_divisi') == $divisi->id ? 'selected' : '' }}>
                                                {{ $divisi->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <!-- {{-- JABATAN --}} -->
                            <div class="row mb-3">
                                <label for="jabatan" class="col-sm-2 col-form-label text-start">Jabatan<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                                    <input name="jabatan" class="form-control" id="jabatan"
                            ...
                            <!-- {{-- TANGGAL --}} -->
                            <div class="row mb-3">
                                <label for="tanggal_lahir" class="col-sm-2 col-form-label text-start">Tanggal Lahir<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control"
                                        value="{{ old('tanggal_lahir', $staffDept->tanggal_lahir ?? '') }}" required>
                                </div>
                            </div>

                            <!-- {{-- EMAIL --}} -->
                            <div class="row mb-3">
                                <label for="email" class="col-sm-2 col-form-label text-start">Email<small
                                        class="text-danger"> *</small></label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="scopus" class="form-control" id="scopus"
                                        value="{{ old('scopus') }}" placeholder="Masukkan link Scopus">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="sinta" class="form-control" id="sinta"
                                        value="{{ old('sinta') }}" placeholder="Masukkan link Sinta">
                                </div>
                            </div>
                            <!-- {{-- GOOGLE SCHOLAR --}} -->
                            <div class="row mb-3">
                                <label for="google_scholar" class="col-sm-2 col-form-label text-start">Google
                                    Scholar</label>
                                <div class="col-sm-10">
                                    <input type="text" name="google_scholar" class="form-control" id="google_scholar"
                                        value="{{ old('google_scholar') }}" placeholder="Masukkan link Google Scholar">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="website" class="form-control" id="website"
                                        value="{{ old('website') }}" placeholder="Masukkan link website pribadi">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="researchgate" class="form-control" id="researchgate"
                                        value="{{ old('researchgate') }}" placeholder="Masukkan link ResearchGate">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="keahlian" class="form-control" id="keahlian" rows="3"
                                        placeholder="Masukkan bidang keahlian">{{ old('keahlian') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="publikasi" class="form-control" id="publikasi" rows="3"
                                        placeholder="Masukkan link publikasi">{{ old('publikasi') }}</textarea>
                                </div>
                            </div>

                            <!-- {{-- RIWAYAT PENDIDIKAN --}} -->
                            <div class="row mb-3">
                                <label for="riwayat_pendidikan" class="col-sm-2 col-form-label text-start">Riwayat
                                    Pendidikan</label>
                                <div class="col-sm-10">
                                    <textarea name="riwayat_pendidikan" class="form-control" id="riwayat_pendidikan" rows="3"
                                        placeholder="Masukkan riwayat pendidikan">{{ old('riwayat_pendidikan') }}</textarea>
                                </div>
                            </div>
