        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Daftar Staff Departemen</h2>
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('staffdept.index') }}" method="GET"
                            class="d-flex align-items-center gap-2 w-50">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari Staff Departemen..." value="{{ request('search') }}">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @forelse($staffdepts as $index => $staff)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($staff->foto)
                                                    <img src="{{ asset($staff->foto) }}" alt="foto staff"
                                                        class="img-thumbnail"
                                            ...
                                            <td class="text-center">
                                                <div style="display:flex; justify-content:center; gap:6px;">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $staff->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $staff->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Apakah Anda yakin ingin menghapus Staff Departemen
                                                                        ini?</div>
                                                                </div>
                                                                <div class="modal-footer justify-content-center">
                                                                    <form
                                                                        action="{{ route('staffdept.destroy', $staff->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                            ...
                            <div class="d-flex justify-content-end mt-3 ">
                                {{ $staffdepts->onEachSide(1)->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
