        ...
        <div class="staff-det-container">
            ...
            <div class="staff-det-card">
                ...
                <div class="staff-det-info">
                    <div class="staff-det-row"><span>Tanggal Lahir</span><span>{{ $staffDept->tanggal_lahir ?? '-' }}</span>
                    </div>
                    <div class="staff-det-row"><span>Email</span><span>{{ $staffDept->email ?? '-' }}</span></div>
                    <div class="staff-det-row"><span>Sinta</span><span><a href="{{ $staffDept->sinta }}"
                                target="_blank">{{ $staffDept->sinta ?? '-' }}</a></span></div>
                    <div class="staff-det-row"><span>Google Scholar</span><span><a href="{{ $staffDept->google_scholar }}"
                                target="_blank">{{ $staffDept->google_scholar ?? '-' }}</a></span></div>
                    <div class="staff-det-row"><span>Scopus</span><span><a href="{{ $staffDept->scopus }}"
                                target="_blank">{{ $staffDept->scopus ?? '-' }}</a></span></div>
                    <div class="staff-det-row"><span>Website</span><span><a href="{{ $staffDept->website }}"
                                target="_blank">{{ $staffDept->website ?? '-' }}</a></span></div>
