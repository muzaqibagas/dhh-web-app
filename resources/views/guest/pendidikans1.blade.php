...
<body>
  ...
  <div class="container my-4">
    ...
    <p style="text-align: justify;">
      ProProgram Studi S1 Hasil Hutan (PS HH) telah mendapatkan akreditasi A 
      dari Badan Akreditasi Nasional Perguruan Tinggi Republik Indonesia (BAN-PT) 
      pada tahun 2006. Pada tahun 211, PS THH juga telah terakreditasi A oleh BAN-PT. 
      Akreditasi tersebut berlaku sejak tanggal 29-Desember 2011 sampai dengan 29 Desember 2016. 
      Selain mendapatkan akreditasi tingkat nasional, PS THH memperoleh Akreditasi Internasional 
      dari The Society of Wood Science and Technology (SWST) yang berkantor pusat di Monona, 
      Wisconsin, Amerika Serikat. Akreditasi diberikan selama sepuluh tahun, mulai dari 1 Januari 
      2015 sampai dengan 1 Januari 2025.
    </p>

    <h4 class="guest-pend-section-title">Kompetensi Lulusan</h4>
    <img src="img/batasgold.png" class="guest-pend-divider" alt="divider">
    <p style="text-align: justify;">Kompetensi lulusan PS THH adalah mempunyai Dasar Ketrampilan, Kemampuan Analisis dan Sintesis yang andal, 
      serta Profesionalisme dan Kemandirian yang kuat pada bidang ilmu dan teknologi hasil hutan serta berjiwa kewirausahaan. 
      Kompetensi tersebut dijabarkan dalam 4 bagian, yaitu:</p>
    ...
    <h4 class="guest-pend-section-title">Capaian Pembelajaran</h4>
    <img src="img/batasgold.png" class="guest-pend-divider" alt="divider">
