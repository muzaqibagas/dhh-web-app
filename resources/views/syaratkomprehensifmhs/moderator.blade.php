            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card shadow-sm">
                    <div class="card-body bg-light">
                        ...
                        <form action="{{ route('syaratkomprehensifmhs.tambahModerator', $syaratKomprehensifmhs->id) }}"
                            method="POST" class="row g-3">
                            @csrf
                            <input type="hidden" name="nim" value="{{ $nim }}">
                            <div class="d-flex flex-column gap-3">
                                <div class="col-12 col-md-8 d-flex align-items-center">
                                    <label for="moderator" class="form-label mb-0 w-50 text-start">Nama Ketua
                                        Sidang</label><span style="margin-right: 8px;">: </span>
                                ...
                                <div class="col-12 col-md-8 d-flex align-items-center">
                                    <label for="penguji" class="form-label mb-0 w-50 text-start">Nama Dosen
                                        Penguji</label><span style="margin-right: 8px;">: </span>
                                ...
                                <div class="col-12 col-md-8 d-flex align-items-center">
                                    <label for="penandatanganundangan" class="form-label mb-0 w-50 text-start">Nama
                                        Penandatangan Undangan</label><span style="margin-right: 8px;">: </span>
                                ...
                                <div class="col-12 col-md-8 d-flex align-items-center">
                                    ...
                                    <input type="text" name="ruangan" id="ruangan" class="form-control"
                                        placeholder="Contoh: Ruang Sidang Lt. 2 / Zoom Meeting"
                                        value="{{ old('ruangan', $syaratKomprehensifmhs->ruangan) }}" required>
                                </div>
