            ...
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('syaratkomprehensifmhs.index') }}" method="GET"
                                ...
                                <tbody>
                                    @forelse ($pendaftar as $pendaftars)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->formulir)
                                                    <a href="{{ route('syaratkomprehensifmhs.show', $pendaftars->id) }}"
                                                        class="btn btn-primary btn-sm d-flex flex-column align-items-center mx-auto"
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->makalah)
                                                    <a href="{{ asset($pendaftars->makalah) }}" target="_blank"
                                                        class="btn btn-primary btn-sm d-flex flex-column align-items-center mx-auto"
                                                        style="width: 90px; height: 30px; padding: 0;">
                                                        <p class="bi bi-eye" style="font-size: 18px"> Lihat</p>
                                                    </a>
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->bukti_sks)
                                                    <a href="{{ asset($pendaftars->bukti_sks) }}" target="_blank"
                                                        class="btn btn-primary btn-sm d-flex flex-column align-items-center mx-auto"
                                                        style="width: 90px; height: 30px; padding: 0;">
                                                        <p class="bi bi-eye" style="font-size: 18px"> Lihat</p>
                                                    </a>
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->bukti_spp)
                                                    <a href="{{ asset($pendaftars->bukti_spp) }}" target="_blank"
                                                        class="btn btn-primary btn-sm d-flex flex-column align-items-center mx-auto"
                                                        style="width: 90px; height: 30px; padding: 0;">
                                                        <p class="bi bi-eye" style="font-size: 18px;"> Lihat</p>
                                                    </a>
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->bukti_kehadiran)
                                                    <a href="{{ asset($pendaftars->bukti_kehadiran) }}" target="_blank"
                                                        class="btn btn-primary btn-sm d-flex flex-column align-items-center mx-auto"
                                                        style="width: 90px; height: 30px; padding: 0;">
                                                        <p class="bi bi-eye" style="font-size: 18px;"> Lihat</p>
                                                    </a>
                                            ...
                                            <td>
                                                <a href="{{ route('undangan.komprehensif.pdf', $pendaftars->id) }}"
                                        ...
                                        <div class="modal fade" id="modalSetujui{{ $pendaftars->id }}" tabindex="-1"
                                            aria-labelledby="modalSetujuiLabel{{ $pendaftars->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-success text-white">
                                                        <h5 class="modal-title"
                                                            id="modalSetujuiLabel{{ $pendaftars->id }}">Konfirmasi
                                                            Persetujuan</h5>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>Apakah Anda Yakin ingin <strong>menyetujui</strong> pendaftaran
                                                            komprehensif atas nama
                                                            <strong>{{ $pendaftars->mahasiswa->nama }}</strong>?</div>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkomprehensifmhs.setujui', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="modalTolak{{ $pendaftars->id }}" tabindex="-1"
                                            aria-labelledby="modalTolakLabel{{ $pendaftars->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-danger text-white">
                                                        <h5 class="modal-title"
                                                            id="modalTolakLabel{{ $pendaftars->id }}">Konfirmasi Penolakan
                                                        </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Tutup"></button>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div>Apakah Anda yakin ingin <strong>menolak</strong> pendaftaran
                                                            komprehensif atas nama
                                                            <strong>{{ $pendaftars->mahasiswa->nama }}</strong>?</div>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkomprehensifmhs.tolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div>
                                                                ...
                                                                <div class="mx-3 d-flex gap-2">
                                                                    <div>
                                                                        <label class="fw-bold fs-6">Alasan Transkrip
                                                                            Nilai</label>
                                                                ...
                                                                <div class="mx-3 d-flex justify-content-center">
                                                                    <div class="w-50">
                                                                        <label class="fw-bold fs-6">Alasan Kartu
                                                                            Bimbingan</label>
                                        ...
                                        <div class="modal fade" id="modalBapDiterima{{ $pendaftars->id }}"
                                            tabindex="-1" aria-labelledby="modalBapDiterimaLabel{{ $pendaftars->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-success text-white">
                                                        <h5 class="modal-title"
                                                            id="modalBapDiterimaLabel{{ $pendaftars->id }}">Konfirmasi
                                                            Kelengkapan Berkas Diterima</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Tutup"></button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <p>Apakah Anda yakin sudah <strong>menerima</strong> Kelengkapan
                                                            Berkas Komprehensif Mahasiswa
                                                            <strong>{{ $pendaftars->mahasiswa->nama }}</strong>?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkomprehensifmhs.bap.diterima', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit" class="btn btn-success">Ya,
                                                                Terima</button>
                                        ...
                                        <div class="modal fade" id="modalBapDitolak{{ $pendaftars->id }}" tabindex="-1"
                                            aria-labelledby="modalBapDitolakLabel{{ $pendaftars->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-danger text-white">
                                                        <h5 class="modal-title"
                                                            id="modalBapDitolakLabel{{ $pendaftars->id }}">Konfirmasi
                                                            Kelengkapan Berkas Ditolak</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Tutup"></button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        <i class="bi bi-x-circle-fill text-danger"
                                                            style="font-size: 3rem;"></i>
                                                        <p>Apakah Anda yakin <strong>belum menerima</strong> Kelengkapan
                                                            Berkas dari <strong>{{ $pendaftars->mahasiswa->nama }}</strong>
                                                            dan mengharuskan mahasiswa melakukan komprehensif kembali?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkomprehensifmhs.bap.ditolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center text-muted py-4">Belum ada mahasiswa
                                                komprehensif.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
