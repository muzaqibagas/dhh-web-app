            ...
            <div class="syarat-card">
                ...
                <ol class="syarat-list">
                    <li><b>Batas Waktu</b><br>
                        ...
                        komprehensif (H-6). Mahasiswa disarankan segera melengkapi seluruh persyaratan agar tidak melewati
                        batas waktu yang telah ditentukan.
                    </li>
                    <li><b>Formulir Pendaftaran Ujian Akhir Sarjana</b><br>
                        Mahasiswa diminta mengisi formulir pendaftaran di halaman Komprehesif dan meminta tanda tangan dosen
                        pembimbing (dapat menggunakan Digsign IPB) dan mengunggah file tersebut di halaman ini. Formulir ini
                        akan disahkan oleh Ketua Departemen oleh pihak TU.
                    </li>
                    <li><b>Telah Menyelesaikan Seluruh Mata Kuliah.</b><br>
                        Mahasiswa diminta mengunggah file dokumen bukti telah menyelesaikan seluruh mata kuliah yang telah
                        ditetapkan di halaman ini. termasuk seminar, dengan jumlah minimal 138 SKS dan IPK keseluruhan
                        minimal 2,00 tanpa nilai E.
                    </li>
                    <li><b>Bukti Pelunasan SPP</b><br>
                        Bukti pembayaran SPP untuk semester berjalan harus diunggah melalui form yang tersedia pada halaman
                        ini. Jika menggunakan tangkapan layar, pastikan informasi pembayaran terlihat dengan jelas dan sudah
                        dalam format .pdf
                    </li>
                    </li>
                    <li><b>Buku Konsultasi</b><br>
                        Mahasiswa diminta menyerahkan buku konsultasi yang telah diisi lengkap dan ditandatangani oleh dosen
                        pembimbing (wajib diserahkan secara fisik ke bagian TU).
                    </li>
                    <li><b>Draft Skripsi yang Siap Ujian</b><br>
                        Mahasiswa diminta membawa draft skripsi yang telah ditandatangani oleh Komisi Pembimbing dan Ketua
                        Departemen. (Sebanyak 3-4 eksemplar wajib diserahkan secara fisik ke bagian TU).
                    </li>
                    <li><b>Proceeding dan Ringkasan (CD & Hardcopy)</b><br>
                        Mahasiswa diminta membawa proceeding (berbahasa Inggris) dan ringkasan skripsi dalam bentuk CD serta
                        1 lembar hardcopy masing-masing (wajib diserahkan secara fisik ke bagian TU).
                    </li>
                </ol>
                ...
                @elseif($syarat && $syarat->status === 'ditolak')
                    <div class="alert alert-warning">
                        ...
                        <ul>
                            @if ($syarat->alasan_formulir)
                                <li><b>Formulir Komprehensif Hasil:</b> {{ $syarat->alasan_formulir }}</li>
                            @endif
                            @if ($syarat->alasan_makalah)
                                <li><b>Draft Skripsi Komprehensif:</b> {{ $syarat->alasan_makalah }}</li>
                            @endif
                            ...
                            @if ($syarat->alasan_bukti_kehadiran)
                                <li><b>Bukti Kartu Bimbingan:</b> {{ $syarat->alasan_bukti_kehadiran }}</li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="upload-section">
                        ...
                        <form action="{{ route('syaratkomprehensifmhs.reupload', $syarat->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @if ($syarat->alasan_formulir)
                                <div class="form-group">
                                    <label>Upload Ulang Formulir Komprehensif Hasil <small class="text-danger">(*format
                            ...
                            @if ($syarat->alasan_makalah)
                                <div class="form-group">
                                    <label>Upload Ulang Draft Skripsi Komprehensif <small class="text-danger">(*format wajib
                                            .PDF)</small></label>
                            ...
                            @if ($syarat->alasan_bukti_sks)
                                <div class="form-group">
                                    <label>Upload Ulang Transkrip Nilai <small class="text-danger">(*format wajib
                                            .PDF)</small></label>
                            ...
                            @if ($syarat->alasan_bukti_kehadiran)
                                <div class="form-group">
                                    <label>Upload Ulang Bukti Kartu Bimbingan Komprehensif <small
                ...
                @elseif ($syarat && $syarat->bap === 'diterima')
                    <div class="alert alert-success">
                        <strong>BAP Anda telah diterima.</strong> Semua persyaratan komprehensif sudah lengkap dan
                        disetujui.
                    </div>
                ...
                @elseif ($syarat && $syarat->bap === 'ditolak' && !$syarat->formulir)
                    <div class="alert alert-warning">
                        <strong>BAP Anda ditolak.</strong> Silakan unggah ulang<strong>Formulir Seminar Hasil</strong>
                        dengan jadwal baru untuk penjadwalan ulang.
                        <ul>
                            @if ($syarat->alasan_formulir)
                                <li><b>Formulir Seminar Hasil:</b> {{ $syarat->alasan_formulir }}</li>
                            @endif
                        </ul>
                    </div>
                ...
                @else
                    <div class="upload-section">
                        ...
                        <form action="{{ route('syaratkomprehensifmhs.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Upload Formulir Pendaftaran Komprehensif <small class="text-danger">(*format wajib
                                        .PDF)</small></label>
                                <input type="file" name="formulir" accept=".pdf,.jpg,.jpeg,.png" required>
                            </div>

                            <div class="form-group">
                                <label>Upload Draft Skripsi Komprehensif <small class="text-danger">(*format wajib
                                        .PDF)</small></label>
                                <input type="file" name="makalah" accept=".pdf" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Upload Bukti Kartu Bimbingan <small class="text-danger">(*format wajib
                                        .PDF)</small></label>
