            ...
            <div class="guest-carousel-slide">
                ...
                <div class="guest-carousel-caption">
                    ...
                    <p>Pengembangan ilmu dan teknologi pemanfaatan hasil hutan untuk menghasilkan
                        ...
                        kimia hasil hutan, biokomposit, desain dan keteknikan struktur kayu dan manajemen industri hasil
                        hutan.</p>
                </div>
            </div>
            ...
            <div class="container position-relative">
                ...
                <div class="guest-menu-wrapper">
                    <div class="guest-menu-slide">
                        ...
                        <!-- Divisi -->
                        <a href="{{ route('konten-dept.sejarah') }}#sej-struktur" class="guest-menu-card">
                            <img src="img/icon3.png" alt="Divisi">
                            <p>Staff Departemen</p>
                        </a>
                        <!-- Pendaftaran -->
                        <a href="{{ route('login') }}" class="guest-menu-card">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                function updateSlide() {
                    const cardWidth = totalCards[0].offsetWidth + 16;
            ...
            <div class="guest-about-container">
                <div class="guest-about-text" data-aos="fade-up">
                    ...
                    <p>Departemen Hasil Hutan terdiri atas
                        <a href="{{ route('pendidikan.s1') }}">Program Studi S1</a> (Teknologi Hasil Hutan),
                        <a href="{{ route('pendidikan.s2') }}">Program Studi S2</a> (Ilmu dan Teknologi Hasil Hutan), dan
                        <a href="{{ route('pendidikan.s3') }}">Program Studi S3</a> (Ilmu dan Teknologi Hasil Hutan).
                    </p>
                    <a href="{{ route('konten-dept.sejarah') }}" class="guest-btn-about">Lihat Selengkapnya</a>
            ...
            <div class="guest-blog-grid">
                ...
                @if ($featured)
                    <div class="guest-blog-card guest-featured">
                        <a href="{{ route('artikel.show', $featured->id) }}" class="guest-blog-image">
                            <img src="{{ asset($featured->foto) }}" alt="{{ $featured->judul }}">
                            <div class="guest-overlay">
                                <div class="guest-meta">
                                    <span>{{ \Carbon\Carbon::parse($featured->tanggal)->format('M d, Y') }}</span> |
                                    <span>{{ $featured->kategoriartikel->nama ?? '-' }}</span>
                                </div>
                ...
                @foreach ($artikels as $item)
                    <div class="guest-blog-card guest-side">
                        <a href="{{ route('artikel.show', $item->id) }}" class="guest-blog-image">
                            <img src="{{ asset($item->foto) }}" alt="{{ $item->judul }}">
                            <div class="guest-overlay">
                                <div class="guest-meta">
                                    <span>{{ \Carbon\Carbon::parse($item->tanggal)->format('M d, Y') }}</span> |
                                    <span>{{ $item->kategoriartikel->nama ?? '-' }}</span>
                                </div>
                                <h3>{{ $item->judul }}</h3>
                            </div>
                        </a>
        ...
        <section class="guest-galery-section">
            ...
            <div class="guest-galery-grid guest-galery-grid-5">
                @foreach ($galeri as $item)
                    <div class="guest-galery-item" data-category="{{ $item->kategorigaleri->nama ?? '-' }}">
        ...
        <section class="guest-galery-section">
            ...
            <div id="guestAlumniCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-indicators mb-4">
                    @foreach ($reviewAlumni as $key => $review)
                        <button type="button" data-bs-target="#guestAlumniCarousel"
                ...
                <div class="carousel-inner">
                    @foreach ($reviewAlumni as $key => $review)
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            <div class="p-4 guest-rounded-8 text-white bg-opacity-75 d-flex align-items-center"
                                style="background: url('img/bgalumni.jpg') center center / cover no-repeat; height: 380px;">
                                <div class="row align-items-center">

                                    <!-- Gambar alumni -->
                                    <div class="col-md-3 text-center mb-3 mb-md-0">
                                        <img src="{{ asset($review->foto) }}" alt="alumni"
                                            class="guest-alumni-img rounded-circle img-fluid shadow w-75 h-75">
                                    </div>

                                    <!-- Teks -->
                                    <div class="col-md-9">
                                        <h5 class="fw-bold mb-1">{{ $review->nama }}</h5>
                                        <p class="text-white-50 fst-italic mb-3 text-justify ">
                                            {{ $review->review }}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="accordion guest-accordion" id="guestAccordion">
                            ...
                            <div class="accordion-item guest-accordion-item mb-3">
                                <h2 class="accordion-header" id="guestHeadingOne">
                                    <button class="accordion-button guest-accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#guestCollapseOne"
                                        aria-expanded="false" aria-controls="guestCollapseOne">
                                ...
                                <div id="guestCollapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body guest-accordion-body">
                                        ...
                                        Departemen Hasil Hutan Fakultas Kehutanan dan Lingkungan IPB. Program Studi
                                        Teknologi Hasil Hutan memperoleh
                                        akreditasi A berdasarkan keputusan dari Badan Akreditasi Nasional - Perguruan Tinggi
                                        (BAN-PT) No.
                                        0140/SK/BAN-PT/Akred/S/I/2017 tanggal 10 Januari 2017 dan berlaku sampai tanggal 10
                                        Januari 2022.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item guest-accordion-item mb-3">
                                <h2 class="accordion-header" id="guestHeadingTwo">
                                    <button class="accordion-button guest-accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#guestCollapseTwo"
                                        aria-expanded="false" aria-controls="guestCollapseTwo">
                                ...
                                <div id="guestCollapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body guest-accordion-body">
                                        Program Studi S2 Ilmu dan Teknologi Hasil Hutan (PS THH) diselenggarakan oleh
                                        Departemen
                                        Hasil Hutan (DHH) IPB dengan sistem kurikulum Mayor-Minor, yang mulai diterapkan
                            ...
                            <div class="accordion-item guest-accordion-item mb-3">
                                <h2 class="accordion-header" id="guestHeadingThree">
                                    <button class="accordion-button guest-accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#guestCollapseThree"
                                        aria-expanded="false" aria-controls="guestCollapseThree">
                                ...
                                <div id="guestCollapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body guest-accordion-body">
                                        ...
                                        Departemen Hasil Hutan (DHH) IPB dengan sistem kurikulum Mayor-Minor yang berlaku
                                        sejak tahun ajaran 2007/2008.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="guest-contact-box">
                            ...
                            <div class="info-content">
                                <h4>Alamat Kami</h4>
                                <p>Departemen Hasil Hutan, Jl. Ulin, Babakan, kec. Dramaga, Kabupaten Bogor, Jawa Barat
                                    16680</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="guest-map-container">
                <div class="row">
                    <div class="guest-map-section" data-aos="fade-up" data-aos-delay="200">
                        <iframe
                            src="https://maps.google.com/maps?q=Departemen%20Hasil%20Hutan%20&t=m&z=13&output=embed&iwloc=near"
