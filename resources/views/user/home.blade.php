          ...
          <a href="{{ route('artikel.show', $featured->id) }}" class="guest-blog-image">
            ...
            <div class="guest-overlay">
              <div class="guest-meta">
                <span>{{ \Carbon\Carbon::parse($featured->tanggal)->format('M d, Y') }}</span> | <span>{{ $featured->kategoriartikel->nama ?? '-' }}</span>
              </div>
      ...
      <div id="guestAlumniCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-indicators mb-4">
          @foreach($reviewAlumni as $key => $review)
              <button type="button" data-bs-target="#guestAlumniCarousel" data-bs-slide-to="{{ $key }}"
                  class="{{ $key == 0 ? 'active' : '' }}" 
            ...
            <div class="p-4 guest-rounded-8 text-white bg-opacity-75 d-flex align-items-center"
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-3 text-center mb-3 mb-md-0">              
                  <img src="{{ asset($review->foto) }}" alt="alumni" class="guest-alumni-img rounded-circle img-fluid shadow w-75 h-75">
                </div>
