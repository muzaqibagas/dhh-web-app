                ...
                <div class="col-md-6">
                    <div class="card guest-dc-card h-100">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ asset('layanan akademik/Form-Distribusi-Skripsi-1.pdf') }}"
                                class="btn btn-primary btn-sm">Unduh</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card guest-dc-card h-100">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ asset('layanan akademik/TANDA-TERIMA-PROPOSAL-PENELITIAN.pdf') }}"
                                class="btn btn-primary btn-sm">Unduh</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card guest-dc-card h-100">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ asset('layanan akademik/FRM-FAHUTAN-24-00-Formulir-Pelayanan.pdf') }}"
                                class="btn btn-primary btn-sm">Unduh</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card guest-dc-card h-100">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ asset('layanan akademik/FORM-SURAT-IJIN-SAKIT-s1.pdf') }}"
                                class="btn btn-primary btn-sm">Unduh</a>
                        </div>
                    </div>
                </div>
