        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Kategori Artikel</h2>
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('kategoriartikel.index') }}" method="GET"
                            class="d-flex align-items-center gap-2 w-50">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari Kategori Artikel..." value="{{ request('search') }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $kategoriArtikels->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $kategoriArtikels->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Apakah Anda yakin ingin menghapus Kategori Artikel
                                                                        ini?</div>
                                                                </div>
                                                                <div class="modal-footer justify-content-center">
                                                                    <form
                                                                        action="{{ route('kategoriartikel.destroy', $kategoriArtikels->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
