        ...
        <main class="content">
            <div class="container-fluid">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Edit Data Review Alumni</h2>
                </div>
                @if (session('info'))
                ...
                <div class="container mt-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <form action="{{ route('review-alumni.update', $reviewAlumni->id) }}" method="POST"
                                ...
                                <div class="row">
                                        ...
                                        <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nama" id="nama"
                                                    value="{{ old('nama', $reviewAlumni->nama) }}"
                                        ...
                                        <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="angkatan"
                                                    name="angkatan"
                                                    value="{{ old('angkatan', $reviewAlumni->angkatan) }}"
                                        ...
                                        <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="profesi" name="profesi"
                                                    value="{{ old('profesi', $reviewAlumni->profesi) }}"
                                    ...
                                    <div class="col-lg-4 text-center mb-3">
                                        ...
                                        <div id="preview-container"
                                            ...
                                            style="height: 150px;">
                                            <i id="preview-icon" class="bi bi-card-image fs-1 text-muted"
                                                @if ($reviewAlumni->foto) style="display:none;" @endif></i>
                                            <img id="preview-image"
                                                src="{{ $reviewAlumni->foto ? asset($reviewAlumni->foto) : '' }}"
                                                class="img-fluid rounded @if (!$reviewAlumni->foto) d-none @endif"
