        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Review Alumni</h2>
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('review-alumni.index') }}" method="GET"
                                            ...
                                            <td>
                                                <div style="display: flex; justify-content: center; gap: 6px;">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $review->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $review->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Apakah Anda yakin ingin menghapus Review Alumni
                                                                        ini?</div>
                                                                </div>
                                                                <div class="modal-footer justify-content-center">
                                                                    <form
                                                                        action="{{ route('review-alumni.destroy', $review->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
