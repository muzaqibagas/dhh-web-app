        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Edit Data Mitra</h2>
                </div>
                @if (session('info'))
                        ...
                        <div class="table-responsive">
                            ...
                            <form action="{{ route('mitra.update', $mitra->id) }}" method="POST"
                                ...
                                <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="nama" class="form-control" id="mitra"
                                            value="{{ old('nama', $mitra->nama) }}" placeholder="Mitra..." required>
                                    </div>
                                </div>
                                ...
                                <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                    ...
                                    <div class="d-flex justify-content-center mt-3 w-100">
                                        <div id='prereview-container'
                                            ...
                                            style="height: 150px;">
                                            <img id="preview-image" src="{{ $mitra->foto ? asset($mitra->foto) : '' }}"
                                                alt="Preview"
                                                class="img-fluid rounded @if (!$mitra->foto) d-none @endif"
