        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Daftar Mitra</h2>
                                ...
                                <tbody>
                                    @foreach ($mitras as $index => $mitra)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($mitra->foto)
                                                    <img src="{{ asset($mitra->foto) }}" alt="foto mitra"
                                                        class="img-thumbnail"
                                            ...
                                            <td>
                                                <div style="display: flex; justify-content: center; gap: 6px;">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $mitra->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $mitra->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer justify-content-center">
                                                                    <form
                                                                        action="{{ route('mitra.destroy', $mitra->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
