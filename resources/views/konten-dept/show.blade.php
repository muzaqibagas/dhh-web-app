        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Detail Konten Departemen</h2>
                </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <textarea name="sejarah" rows="4" class="form-control" readonly>{{ $kontenDept->sejarah ?? '-' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <textarea name="visi" rows="3" class="form-control" readonly>{{ $kontenDept->visi ?? '-' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <textarea name="misi" rows="3" class="form-control" readonly>{{ $kontenDept->misi ?? '-' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <textarea name="tujuan" rows="6" class="form-control" readonly>{{ $kontenDept->tujuan ?? '-' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <textarea name="kebijakanmutu" rows="5" class="form-control" readonly>{{ $kontenDept->kebijakanmutu ?? '-' }}</textarea>
                            </div>
                        </div>

                        <!-- Tombol Aksi -->
                        <div class="mt-4 me-4 d-flex justify-content-end">
                            <a href="{{ route('konten-dept.edit', $kontenDept->id) }}" class="btn btn-warning">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
