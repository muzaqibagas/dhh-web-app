                    ...
                    <div class="card-body">
                        <form action="{{ route('kontenjenjang.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="foto" class="form-control" accept="image/*"
                                        onchange="previewImage(event, 'preview-foto')" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="capaianpembelajaran" rows="3" class="form-control" placeholder="Capaian Pembelajaran..."
                                        required>{{ old('capaianpembelajaran') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="sertifikatakreditasi" class="form-control"
                                        accept="image/*" onchange="previewImage(event, 'preview-akreditasi')" required>
                                    <div class="preview-wrapper">
                            ...
                            <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                <label class="col-sm-2 preview-akreditasicol-form-label fw-bold text-start">Deskripsi
                                    Akreditasi</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="deskripsiakreditasi"
                                        name="deskripsiakreditasi" value="{{ old('deskripsiakreditasi') }}"
