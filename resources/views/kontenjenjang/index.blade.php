            ...
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('kontenjenjang.index') }}" method="GET"
                            class="d-flex align-items-center gap-2 w-50">
                            <input type="text" name="search" class="form-control" placeholder="Cari Jenjang..."
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div style="display: flex; justify-content: center; gap: 6px;">
                                                    <a href="{{ route('kontenjenjang.edit', $konten->id) }}"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $konten->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $konten->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Apakah Anda yakin ingin menghapus Konten Jenjang
                                                                        ini?</div>
                                                                </div>
                                                                <div class="modal-footer justify-content-center">
                                                                    <form
                                                                        action="{{ route('kontenjenjang.destroy', $konten->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
