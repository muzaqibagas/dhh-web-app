        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Konten Jenjang</h2>
                </div>
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="table-responsive">
                            <form action="{{ route('kontenjenjang.update', $kontenJenjang->id) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" name="id_jenjang"
                                            value="{{ $kontenJenjang->id_jenjang }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="foto" class="form-control" accept="image/*"
                                            onchange="previewSingle(this, 'preview-foto')">
                                        @if ($kontenJenjang->foto)
                                            <img id="preview-foto" src="{{ asset($kontenJenjang->foto) }}"
                                                alt="Foto" class="preview-img mt-2">
                                        @else
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="capaianpembelajaran" rows="3" class="form-control" placeholder="Capaian Pembelajaran..."
                                            required>{{ old('capaianpembelajaran', $kontenJenjang->capaianpembelajaran) }}</textarea>
                                    </div>
                                </div>
                                        ...
                                        <div id="leaflet-preview"
                                            ...
                                            @if ($kontenJenjang->leaflets && $kontenJenjang->leaflets->count())
                                                @foreach ($kontenJenjang->leaflets as $lf)
                                                    <img src="{{ asset($lf->gambar) }}" class="preview-img"
                                                        alt="Leaflet">
                                                @endforeach
                                            @endif
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="sertifikatakreditasi" class="form-control"
                                            accept="image/*" onchange="previewSingle(this, 'preview-akreditasi')">
                                        @if ($kontenJenjang->sertifikatakreditasi)
                                            <img id="preview-akreditasi"
                                                src="{{ asset($kontenJenjang->sertifikatakreditasi) }}" alt="Akreditasi"
                                                class="preview-img mt-2">
                                        @else
                                            <img id="preview-akreditasi" class="preview-img mt-2 d-none"
                                                alt="Akreditasi">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="deskripsiakreditasi" class="form-control"
                                            value="{{ old('deskripsiakreditasi', $kontenJenjang->deskripsiakreditasi) }}"
                                            placeholder="Deskripsi Akreditasi..." required>
                                    </div>
                                </div>
