        ...
        <div class="container-fluid mt-4">        
            ...
            <div class="card shadow-sm">                   
                <div class="card-body bg-light">
                    ...
                    <form action="{{ route('syaratujian.tambahModerator' , $syaratUjian->id) }}" method="POST" class="row g-3">                    
                        @csrf
                        <input type="hidden" name="nim" value="{{ $nim }}">                                                 
                        <div class="d-flex flex-column gap-3">                              
                          <div class="col-12 col-md-8 d-flex align-items-center">
                              @php
                                  $labelModerator = $syaratUjian->jenis_ujian === 'komprehensif'
                                      ? 'Ketua Sidang'
                                      : 'Moderator';
                              @endphp

                              <label for="moderator" class="form-label mb-0 w-50">Nama Dosen {{ $labelModerator }}</label>
                          ...
                          <div class="col-12 col-md-8 d-flex align-items-center">
                              <label for="penandatanganundangan" class="form-label mb-0 w-50">Nama Penandatangan Undangan</label>
                              <span style="margin-right: 8px;">: </span>
                          ...
                          @if($syaratUjian->jenis_ujian === 'komprehensif')
                            ...
                            <div class="col-12 col-md-8 d-flex align-items-center">
                                ...
                                <input type="text" 
                                    ...
                                    placeholder="Contoh: Ruang Sidang Lt. 2 / Zoom"
                                    required>
                            </div>
                          @endif  
