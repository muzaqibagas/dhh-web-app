    ...
    <div class="container-fluid mt-4">
        <div class="adm-header">
            ...
            <div class="d-flex justify-content-end align-items-center gap-2">                    
              <form action="{{ route('syaratujian.index') }}" method="GET" class="d-flex justify-content-end align-items-center gap-2 w-100">
              ...
              <div class="table-responsive">
                  <table class="table table-bordered align-middle mb-0">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td class="align-middle text-center">
                              @if($pendaftars->formulir)
                                <a href="{{ route('syaratujian.show', $pendaftars->id) }}" class="btn btn-primary btn-sm d-flex flex-column align-items-center mx-auto" style="width: 90px; height: 30px; padding: 0;">                                                                                                                          
                            ...
                            <td>                                                                         
                              <a href="{{ route('undangan.pdf', $pendaftars->id) }}" class="btn btn-primary">Download</a>                                                                
                            </td>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">                
                                  <form action="{{ route('syaratujian.setujui', $pendaftars->id) }}" method="POST">
                                    @csrf
                          ...
                          <div class="modal fade" id="modalTolak{{ $pendaftars->id }}" tabindex="-1" aria-labelledby="modalTolakLabel{{ $pendaftars->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">                                  
                                  <form action="{{ route('syaratujian.tolak', $pendaftars->id) }}" method="POST">
                                    @csrf                                                                          
                                      <div>
                          ...
                          <div class="modal fade" id="modalBapDiterima{{ $pendaftars->id }}" tabindex="-1" aria-labelledby="modalBapDiterimaLabel{{ $pendaftars->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                  <form action="{{ route('syaratujian.bap.diterima', $pendaftars->id) }}" method="POST">
                                    @csrf
                          ...
                          <div class="modal fade" id="modalBapDitolak{{ $pendaftars->id }}" tabindex="-1" aria-labelledby="modalBapDitolakLabel{{ $pendaftars->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                  <form action="{{ route('syaratujian.bap.ditolak', $pendaftars->id) }}" method="POST">
                                    @csrf
                        ...
                        @empty
                          <tr>
                            <td colspan="9" class="text-center text-muted py-4">Belum ada data {{ ucfirst($jenis) }}</td>
                          </tr>
                        @endforelse
                      </tbody>
                  </table>
