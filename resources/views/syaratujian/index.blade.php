                                ...
                                <tbody>
                                    @forelse ($data as $pendaftars)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('undangan.pdf', $pendaftars->id) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form action="{{ route('syaratujian.setujui', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="modalTolak{{ $pendaftars->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form action="{{ route('syaratujian.tolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div>
                                        ...
                                        <div class="modal fade" id="modalBapDiterima{{ $pendaftars->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratujian.bap.diterima', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit" class="btn btn-success">Ya,
                                                                Terima</button>
                                        ...
                                        <div class="modal fade" id="modalBapDitolak{{ $pendaftars->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratujian.bap.ditolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center text-muted py-4">Belum ada data
                                                {{ ucfirst($jenis) }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
