...
<!-- SIDEBAR -->
  <div class="main-container">
    ...
    <main class="content">              
        <div style="background:#fff; padding:24px; border-radius:10px; box-shadow:0 2px 6px rgba(0,0,0,0.08); max-width:800px; margin:auto;" class="shadow">
            <!-- Header -->
            <div style="display:flex; align-items:center; gap:20px; margin-bottom:24px;">
                <div style="width:90px; height:90px; border-radius:50%; background:#c7d2fe; display:flex; align-items:center; justify-content:center; font-size:32px; font-weight:bold; color:#1e3a8a;">
                    @if($user->foto)
                        <img id="preview-image" src="{{ asset(trim($user->foto)) }}" alt="" class="w-100 h-100 object-fit-cover rounded-circle">
                    @else
