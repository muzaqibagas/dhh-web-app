        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Edit Pimpinan DHH</h2>
                </div>
                @if (session('info'))
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form action="{{ route('ketuadhh.update', $ketuaDHH->id) }}" method="POST"
                                ...
                                <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                    ...
                                    <div class="col-sm-10 d-flex align-items-center">
                                        ...
                                        <select name="tahun_selesai" id="tahun_selesai" class="form-select ms-2"
                                            required>
                                ...
                                <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                    ...
                                    <!-- input file -->
                                    <div class="col-sm-10">
                                        <input type="file" name="foto" class="form-control" id="logo"
                                            accept="image/*">
                                    </div>
                                    <div class="d-flex justify-content-center mt-3 w-100">
                                        <div id='prereview-container'
                                            class="border rounded bg-light d-flex align-items-center justify-content-center mb-2"
                                            style="height: 150px;">
                                            <img id="preview-image"
                                                src="{{ $ketuaDHH->foto ? asset($ketuaDHH->foto) : '' }}" alt="Preview"
                                                class="img-fluid rounded @if (!$ketuaDHH->foto) d-none @endif"
