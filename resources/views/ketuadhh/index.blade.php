                ...
                <div class="adm-header">
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('ketuadhh.index') }}" method="GET"
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Cari Ketua DHh..."
                                ...
                                <tbody>
                                    @foreach ($ketua_dhhs as $index => $ketuadhh)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($ketuadhh->foto)
                                                    <img src="{{ asset($ketuadhh->foto) }}" alt="foto pimpinan dhh"
                                                        class="img-thumbnail"
                                            ...
                                            <td>
                                                <div style="display: flex; justify-content: center; gap: 6px;">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $ketuadhh->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $ketuadhh->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Apakah Anda yakin ingin menghapus Ketua DHH ini?
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer justify-content-center">
                                                                    <form
                                                                        action="{{ route('ketuadhh.destroy', $ketuadhh->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
