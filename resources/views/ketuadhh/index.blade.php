        ...
        <div class="card-body">
            <div class="table-responsive">
                          ...
                          <td class="text-center">
                            ...
                            <td>
                              <div style="display: flex; justify-content: center; gap: 6px;">
                                ...
                                <button type="submit" class="btn btn-danger btn-sm" style="width: 30px; height: 30px; padding: 0;" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $ketuadhh->id }}">
                                  <i class="bi bi-trash" style="font-size: 18px;"></i>
                                </button>
                                <div class="modal fade" id="hapusModal{{ $ketuadhh->id }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body d-flex flex-column align-items-center justify-content-center">                                          
                                        ...
                                        <div>Apakah Anda yakin ingin menghapus Ketua DHH ini?</div>                                          
                                      </div>
                                      <div class="modal-footer justify-content-center">
                                        <form action="{{route('ketuadhh.destroy', $ketuadhh->id)}}" method="POST">
                                          @csrf
                                          @method('DELETE')                                            
                ...
                <div class="d-flex justify-content-end mt-3 ">
                  {{ $ketua_dhhs->onEachSide(1)->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
