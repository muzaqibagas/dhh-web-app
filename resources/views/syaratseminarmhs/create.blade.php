            ...
            <div class="syarat-card">
                ...
                <ol class="syarat-list">
                    <li><b>Batas Waktu</b><br>
                        Pengurusan administrasi seminar tugas akhir paling lambat dilakukan 4 hari kerja sebelum pelaksanaan
                        seminar (H-4). Mahasiswa disarankan segera melengkapi seluruh persyaratan agar tidak melewati batas
                        waktu yang telah ditentukan.
                    </li>
                    <li><b>Jumlah Kehadiran Seminar</b><br>
                        Mahasiswa hanya dapat mendaftar seminar setelah memenuhi jumlah minimal kehadiran, yaitu 10 kali
                        seminar di Departemen Hasil Hutan dan 5 kali seminar di luar Departemen Hasil Hutan.
                    </li>
                    ...
                    <li><b>Formulir Pendaftaran Seminar</b><br>
                        Mahasiswa wajib mengisi formulir pendaftaran seminar di halaman Seminar. Setelah diisi, formulir
                        tersebut harus ditandatangani oleh dosen pembimbing (dapat menggunakan Digsign IPB) dan kemudian
                        diunggah kembali melalui halaman ini. Setelah diterima, formulir akan disahkan oleh Ketua Departemen
                        melalui bagian Tata Usaha (TU).
                    </li>
                    <li><b>Makalah Seminar</b><br>
                        Mahasiswa wajib mengunggah makalah seminar (format .pdf) yang telah disetujui dan ditandatangani
                        oleh dosen pembimbing melalui halaman ini.
                    </li>
                ...
                @if ($syarat && $syarat->status === 'disetujui')
                    <div class="alert alert-success">
                        Dokumen Anda sudah <b>disetujui</b>. Anda tidak bisa upload lagi, silahkan melaksanakan Seminar
                        Hasil.
                    </div>
                ...
                @elseif($syarat && $syarat->status === 'ditolak')
                    <div class="alert alert-warning">
                        ...
                        <ul>
                            ...
                            @if ($syarat->alasan_makalah)
                                <li><b>Makalah Seminar Hasil:</b> {{ $syarat->alasan_makalah }}</li>
                            @endif
                            ...
                            @if ($syarat->alasan_bukti_kehadiran)
                                <li><b>Bukti Kehadiran:</b> {{ $syarat->alasan_bukti_kehadiran }}</li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="upload-section">
                        ...
                        <form action="{{ route('syaratseminarmhs.reupload', $syarat->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @if ($syarat->alasan_formulir)
                                <div class="form-group">
                                    <label>Upload Ulang Formulir Seminar Hasil <small class="text-danger">(*format wajib
                                            .PDF)</small></label>
                            ...
                            @if ($syarat->alasan_makalah)
                                <div class="form-group">
                                    <label>Upload Ulang Makalah Seminar Hasil <small class="text-danger">(*format wajib
                                            .PDF)</small></label>
                            ...
                            @if ($syarat->alasan_bukti_kehadiran)
                                <div class="form-group">
                                    <label>Upload Ulang Bukti Kehadiran Seminar Hasil <small class="text-danger">(*format
                ...
                @elseif ($syarat && $syarat->bap === 'diterima')
                    <div class="alert alert-success">
                        <strong>BAP Anda telah diterima.</strong> Semua persyaratan seminar hasil sudah lengkap dan
                        disetujui.
                    </div>
                ...
                @else
                    <div class="upload-section">
                        ...
                        <form action="{{ route('syaratseminarmhs.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Upload Formulir Pendaftaran Seminar Hasil <small class="text-danger">(*format wajib
                                        .PDF)</small></label>
                                <input type="file" name="formulir" accept=".pdf" required>
                            </div>

                            <div class="form-group">
                                <label>Upload Makalah Seminar Hasil <small class="text-danger">(*format wajib
                                        .PDF)</small></label>
                                <input type="file" name="makalah" accept=".pdf" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Upload Bukti Kehadiran Seminar <small class="text-danger">(*format wajib
                                        .PDF)</small></label>
                                <input type="file" name="bukti_kehadiran" accept=".pdf" required>
                            </div>
