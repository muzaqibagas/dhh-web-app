            ...
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('syaratseminarmhs.index') }}" method="GET"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->formulir)
                                                    <a href="{{ route('syaratseminarmhs.show', $pendaftars->id) }}"
                                            ...
                                            <td>
                                                <a href="{{ route('undangan.seminar.pdf', $pendaftars->id) }}"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>Apakah Anda yakin ingin <strong>menyetujui</strong> pendaftaran
                                                            seminar hasil atas nama
                                                            <strong>{{ $pendaftars->mahasiswa->nama }}</strong>?</div>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratseminarmhs.setujui', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="modalTolak{{ $pendaftars->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratseminarmhs.tolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <p>Apakah Anda yakin sudah <strong>menerima</strong> Kelengkapan
                                                            Berkas Seminar Hasil Mahasiswa
                                                            <strong>{{ $pendaftars->mahasiswa->nama }}</strong>?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratseminarmhs.bap.diterima', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit" class="btn btn-success">Ya,
                                                                Terima</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <p>Apakah Anda yakin <strong>belum menerima</strong> Kelengkapan
                                                            ...
                                                            dan mengharuskan mahasiswa melakukan seminar hasil kembali?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratseminarmhs.bap.ditolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
