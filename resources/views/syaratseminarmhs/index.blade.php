                          ...
                          <tr>
                              ...
                              <td>     
                                 @if ($pendaftars->status == 'pending')                           
                                  <form action="{{ route('syaratseminarmhs.setujui', $pendaftars->id) }}" method="POST" class="d-inline">
                                      @csrf
                                  ...
                                  <form action="{{ route('syaratseminarmhs.tolak', $pendaftars->id) }}" method="POST" class="d-inline">
                                      @csrf
