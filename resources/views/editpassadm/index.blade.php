    ...
    <div class="main-container">
        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <h2 class="page-title text-dark mb-0">Ubah Kata Sandi Akun</h2>
            </div>
            <div class="d-flex justify-content-center align-items-center w-100 mt-4">
                <div class="card p-4 shadow-sm w-75 border-2" style="border:solid #1b2a6d">
                    <form method="POST" action="{{ route('editpassadm.update') }}">
                        @csrf
                        ...
                        <div class="text-start mb-4">
                            <label class="form-label fw-bold mb-0">Kata Sandi Saat Ini</label>
                            <input type="password" name="current_password" class="form-control"
                                style="background-color:#f5f5f5" placeholder="Masukkan kata sandi saat ini" required>
                        </div>

                        <div class="text-start mb-4">
                            <label class="form-label fw-bold mb-0">Kata Sandi Baru</label>
                            <input type="password" name="new_password" class="form-control"
                                style="background-color:#f5f5f5" placeholder="Masukkan kata sandi baru" required>
                        </div>

                        <div class="text-start mb-4">
                            <label class="form-label fw-bold mb-0">Konfirmasi Kata Sandi Baru</label>
                            <input type="password" name="new_password_confirmation" class="form-control"
                                style="background-color:#f5f5f5" placeholder="Konfirmasi kata sandi baru" required>
                        </div>
