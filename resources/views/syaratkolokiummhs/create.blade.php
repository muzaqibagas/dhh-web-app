             ...
             <div class="syarat-card">
                 ...
                 <ol class="syarat-list">
                     <li><b>Batas Waktu Pengurusan Administrasi</b><br>
                         ...
                         pelaksanaan seminar (H-4). Mahasiswa disarankan segera melengkapi seluruh persyaratan agar tidak
                     ...
                     <li><b>Formulir Pendaftaran Kolokium</b><br>
                         ...
                         ditandatangani oleh dosen pembimbing (dapat menggunakan Digsign IPB) dan kemudian diunggah kembali
                         melalui halaman ini. Setelah diterima, formulir akan disahkan oleh Ketua Departemen melalui bagian
                         Tata Usaha (TU).
                     </li>
                     <li><b>Makalah Kolokium</b><br>
                         Mahasiswa wajib mengunggah makalah kolokium (format .pdf) yang telah disetujui dan ditandatangani
                     ...
                     <li><b>Bukti Pelunasan SPP</b><br>
                         ...
                         ini. Jika menggunakan tangkapan layar, pastikan informasi pembayaran terlihat dengan jelas dan
                         sudah dalam format .pdf
                     </li>
                     <li><b>Map Folio (4 Buah)</b><br>
                         Siapkan dan kumpulkan 4 buah map folio secara fisik ke bagian administrasi bersamaan dengan makalah
                         kolokium setelah semua dokumen diunggah secara daring.
                     </li>
                 </ol>
                 ...
                 @elseif($syarat && $syarat->status === 'ditolak')
                     <div class="alert alert-warning">
                         ...
                         <ul>
                             @if ($syarat->alasan_formulir)
                                 <li><b>Formulir Kolokium:</b> {{ $syarat->alasan_formulir }}</li>
                             @endif
                             @if ($syarat->alasan_makalah)
                                 <li><b>Makalah Kolokium:</b> {{ $syarat->alasan_makalah }}</li>
                             @endif
                     ...
                     <div class="upload-section">
                         ...
                         <form action="{{ route('syaratkolokiummhs.reupload', $syarat->id) }}" method="POST"
                             enctype="multipart/form-data">
                             @csrf
                             @if ($syarat->alasan_formulir)
                                 <div class="form-group">
                                     <label>Upload Ulang Formulir Kolokium <small class="text-danger">(*format wajib
                                             .PDF)</small></label>
                             ...
                             @if ($syarat->alasan_makalah)
                                 <div class="form-group">
                                     <label>Upload Ulang makalah Kolokium <small class="text-danger">(*format wajib
                                             .PDF)</small></label>
                             ...
                             @if ($syarat->alasan_bukti_kehadiran)
                                 <div class="form-group">
                                     <label>Upload Ulang Bukti Kehadiran Kolokium <small class="text-danger">(*format wajib
                                             .PDF)</small></label>
                 ...
                 @elseif ($syarat && $syarat->bap === 'ditolak' && !$syarat->formulir)
                     <div class="alert alert-warning">
                         <strong>BAP Anda ditolak.</strong> Silakan unggah ulang<strong>Formulir Kolokium</strong> dengan
                         jadwal baru untuk penjadwalan ulang.
                         <ul>
                             @if ($syarat->alasan_formulir)
                                 <li><b>Formulir Kolokium:</b> {{ $syarat->alasan_formulir }}</li>
                             @endif
                 ...
                 @else
                     <div class="upload-section">
                         ...
                         <form action="{{ route('syaratkolokiummhs.store') }}" method="POST"
                             enctype="multipart/form-data">
                             @csrf
                             <div class="form-group">
                                 <label>Upload Formulir Pendaftaran Kolokium <small class="text-danger">(*format wajib
                                         .PDF)</small></label>
                                 <input type="file" name="formulir" accept=".pdf" required>
                             </div>

                             <div class="form-group">
                                 <label>Upload Makalah Kolokium <small class="text-danger">(*format wajib
                                         .PDF)</small></label>
                                 <input type="file" name="makalah" accept=".pdf" required>
                             </div>
                             ...
                             <div class="form-group">
                                 <label>Upload Bukti Kehadiran Kolokium <small class="text-danger">(*format wajib
                                         .PDF)</small></label>
                                 <input type="file" name="bukti_kehadiran" accept=".pdf" required>
                             </div>
