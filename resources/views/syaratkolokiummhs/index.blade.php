            ...
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('syaratkolokiummhs.index') }}" method="GET"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                @if ($pendaftars->formulir)
                                                    <a href="{{ route('syaratkolokiummhs.show', $pendaftars->id) }}"
                                            ...
                                            <td>
                                                <a href="{{ route('undangan.kolokium.pdf', $pendaftars->id) }}"
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-secondary btn-sm" disabled
                                                        ...
                                                        style="width: 90px; height: 30px; padding: 0;">
                                                        <i class="bi bi-lock"
                                                            style="font-size: 16px; margin-bottom:0px"></i>
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkolokiummhs.setujui', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="modalTolak{{ $pendaftars->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkolokiummhs.tolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div>
                                                                ...
                                                                <div class="mx-3 d-flex justify-content-center">
                                                                    <div class="w-50">
                                                                        <label class="fw-bold fs-6">Alasan
                                                                            Kehadiran</label>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <p>Apakah Anda yakin sudah <strong>menerima</strong> Kelengkapan
                                                            Berkas Kolokium mahasiswa
                                                            <strong>{{ $pendaftars->mahasiswa->nama }}</strong>?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkolokiummhs.bap.diterima', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit" class="btn btn-success">Ya,
                                                                Terima</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <p>Apakah Anda yakin <strong>belum menerima</strong> Kelengkapan
                                                            ...
                                                            dan mengharuskan mahasiswa melakukan kolokium kembali?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            action="{{ route('syaratkolokiummhs.bap.ditolak', $pendaftars->id) }}"
                                                            method="POST">
                                                            @csrf
