    ...
    <main class="content">
      <div class="card text-start mb-4 p-4" style="background-color:#f3f4f6;">
        ...
        <table class="info-table">
            ...
            <tr>
                <td>Nilai Akhir</td>
                <td>:</td>
                <td>{{ $penilaians->first()?->nilai_akhir !== null ? number_format($penilaians->first()->nilai_akhir, 2) : '-' }}</td>
            </tr>
        </table>
      </div>        
      <div class="card text-start mb-4 p-4">
          ...
          <tbody>
            ...
            <tr style="background-color:#ffffff;">
              ...
              <td style="padding:12px 14px;">
                @php
                  $nilaiMap = [1 => '1 - Kurang', 2 => '2 - Cukup', 3 => '3 - Baik', 4 => '4 - Sangat Baik'];
                @endphp
        ...
        <div style="margin-top:16px; margin-bottom:16px; padding:14px; background:#eef2ff; border-radius:8px; font-size:14px;">
          <strong>Total Nilai Akhir:</strong> {{ $penilaians->first()?->nilai_akhir !== null ? number_format($penilaians->first()->nilai_akhir, 2) : '-' }}
        </div>
        ...
        <div style="margin-top:16px; padding:14px; background:#dcfce7; border-radius:8px; font-size:14px;" class="d-flex flex-column gap-2">          
          <div>
