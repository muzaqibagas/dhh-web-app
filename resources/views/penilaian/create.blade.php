        ...
        <main class="content">
            ...
            <div class="card text-start mb-4 p-4">
                <form id="penilaian_form" action="{{ route('penilaian.store') }}" method="POST">
                                ...
                                <tr style="background-color:#ffffff;">
                                    ...
                                    <td style="padding:12px 14px;">
                                        <select name="nilai[{{ $rubrik->id }}]" id="" required>
                                            ...
                                            <option value="1"
                                                {{ old('nilai.' . $rubrik->id) == '1' ? 'selected' : '' }}>1 - Kurang
                                            </option>
                                            <option value="2"
                                                {{ old('nilai.' . $rubrik->id) == '2' ? 'selected' : '' }}>2 - Cukup</option>
                                            <option value="3"
                                                {{ old('nilai.' . $rubrik->id) == '3' ? 'selected' : '' }}>3 - Baik</option>
                                            <option value="4"
                                                {{ old('nilai.' . $rubrik->id) == '4' ? 'selected' : '' }}>4 - Sangat Baik
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                    ...
                    <textarea name="catatan" placeholder="Tulis catatan penilaian di sini..."
                        style="
              width:100%;
              min-height:70px;
              padding:8px;
