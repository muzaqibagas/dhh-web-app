...
<!-- SIDEBAR -->
  <div class="main-container">
    <aside class="sidebar">
      ...
      @php
        $isProfileComplete = !empty($user->nama)
          && !empty($user->nim)
          && !empty($user->no_hp)
          && !empty($user->email)
          ...
          && !empty($user->foto)        
          && (
              !empty($user->tanda_tangan) || !empty($user->tanda_tangan_img)
          );
      @endphp
      
      @if(!$isProfileComplete)
        <a href="#" class="menu active" data-dropdown="profilemhs">
          <div class="menu-left">
            <i class="bi bi-person"></i>
            <span> Profil Mahasiswa </span>
          </div>
          <span class="dropdownArrow" data-arrow="profilemhs">&#9660;</span>
        </a>
        <div data-menu="profilemhs" style="margin-left:24px; flex-direction:column; display:flex;">
          <a href="/profilemhs" class="submenu-link active-submenu">
