    ...
    <div class="main-container">
        ...
        <main class="content">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="id-card-container p-4 shadow-lg rounded-4 d-flex flex-row align-items-center w-100 mt-0"
                    style="background: linear-gradient(135deg, #e0e7ff 60%, #f5f5f5 100%); border: 2px solid #1b2a6d; min-width: 420px;">
                    <div class="id-photo text-center me-4">
                        <div class="rounded-3 overflow-hidden border border-3 border-primary mx-auto"
                            style="width: 200px; height: 300px; background:#fff; margin-bottom: 10px;">
                            @if ($user->foto)
                                <img id="preview-image" src="{{ asset('profile/' . $user->foto) }}" alt=""
                        ...
                        <input type="file" name="foto" accept="image/*" class="form-control form-control-sm mt-2"
                                ...
                                <div class="col-6">
                                    <div id="preview-sign-box"
                                        ...
                                        @if ($user->tanda_tangan)
                                            <img src="{{ asset('signature/' . $user->tanda_tangan) }}" alt="Tanda Tangan"
                                                style="max-width:100%;max-height:80px;">
                                        @else
                                            <span style="color:#aaa;">Belum ada tanda tangan</span>
                                        @endif
                                    </div>
                                    <img id="preview-upload-ttd" src="#" alt="Preview Upload"
                                        style="display:none; max-width:100%; max-height:80px; margin-top:4px; border:1.5px dashed #1b2a6d; border-radius:6px;" />
                                    <img id="preview-canvas-ttd" src="#" alt="Preview Canvas"
                                        style="display:none; max-width:100%; max-height:80px; margin-top:4px; border:1.5px dashed #1b2a6d; border-radius:6px;" />
                                </div>
                                <div class="col-6">
                                    <div class="signature-box border rounded-2 bg-white"
                                    ...
                                    <div class="mt-2 d-flex gap-2">
                                        ...
                                        <input type="file" name="tanda_tangan_img" id="tanda_tangan_img"
                                            accept="image/*" hidden>
