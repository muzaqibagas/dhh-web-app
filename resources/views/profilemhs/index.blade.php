...
@section('content')
    ...
    <div class="main-container">
        ...
        <main class="content">
            ...
            <div class="id-card-container p-4 shadow-lg rounded-4 d-flex flex-row align-items-center w-100 mt-4"
                ...
                <div class="id-photo text-center me-4">
                    ...
                    <a href="{{ route('profilemhs.edit') }}" class="btn btn-primary w-100"><i
                            class="bi bi-pencil-square"></i> Edit Profile</a>
                </div>
                <div class="id-data flex-grow-1">
                    <div class="mb-2">
                        <label class="form-label fw-bold mb-0">Nama</label>
                        <input type="text" class="form-control form-control-sm" value="{{ $user->nama ?? '-' }}"
                            readonly style="background-color:#f5f5f5;">
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-bold mb-0">NIM</label>
                        <input type="text" class="form-control form-control-sm" value="{{ $user->nim ?? '-' }}" readonly
                            style="background-color:#f5f5f5;">
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-bold mb-0">No Handphone</label>
                        <input type="text" class="form-control form-control-sm" value="{{ $user->no_hp ?? '-' }}"
                            readonly style="background-color:#f5f5f5;">
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control form-control-sm"
                            value="{{ $user->jenis_kelamin ?? '-' }}" readonly style="background-color:#f5f5f5;">
                    </div>
