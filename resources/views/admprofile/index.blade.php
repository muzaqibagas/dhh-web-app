            ...
            <div class="col-md-9 px-2 d-flex justify-content-center align-items-center gap-5 w-100 mt-4">
                    ...
                    @auth
                        <button class="btn-edit-photo">
                            <a href="{{ route('user.edit', Auth::user()->id) }}"
                                class="bi bi-pencil-square text-light text-decoration-none"> Ubah Profil</a>
                        </button>
                    @endauth
                </div>
                ...
                <div class="card p-4 shadow-sm w-100 border-2" style="border:solid #1b2a6d">
                    <div class="text-start mb-2">
                        <label class="form-label fw-bold mb-0">Nama Pengguna</label>
                        <input type="text" class="form-control" style="background-color:#f5f5f5"
                            value="{{ Auth::user()->username ?? 'Guest' }}" readonly>
                    </div>
                    <div class="text-start mb-2">
                        <label class="form-label fw-bold mb-0">Nama</label>
                        <input type="text" class="form-control" style="background-color:#f5f5f5"
                            value="{{ Auth::user()->nama ?? 'Guest' }}" readonly>
                    </div>
                    <div class="text-start mb-2">
                        <label class="form-label fw-bold mb-0">Email</label>
                        <input type="text" class="form-control" style="background-color:#f5f5f5"
                            value="{{ Auth::user()->email ?? 'Guest' }}" readonly>
                    </div>
                    <div class="text-start mb-2">
                        <label class="form-label fw-bold mb-0">Jenis Kelamin</label>
                        <input type="text" class="form-control" style="background-color:#f5f5f5"
                            value="{{ Auth::user()->jenis_kelamin ?? 'Guest' }}" readonly>
                    </div>
                </div>
            </div>
        </main>
