                    ...
                    <form method="POST" action="{{ route('editpassmhs.update') }}">
                        ...
                        <div class="text-start mb-4">
                            ...
                            <input type="password" name="current_password" class="form-control"
                                style="background-color:#f5f5f5" placeholder="Masukkan password saat ini" required>
                        </div>

                        <div class="text-start mb-4">
                            <label class="form-label fw-bold mb-0">Password Baru</label>
                            <input type="password" name="new_password" class="form-control" style="background-color:#f5f5f5"
                        ...
                        <div class="text-start mb-4">
                            ...
                            <input type="password" name="new_password_confirmation" class="form-control"
                                style="background-color:#f5f5f5" placeholder="Konfirmasi password baru" required>
                        </div>
