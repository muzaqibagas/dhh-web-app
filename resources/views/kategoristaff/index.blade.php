        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Kategori Staff</h2>
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        <form action="{{ route('kategoristaff.index') }}" method="GET"
                            class="d-flex align-items-center gap-2 w-50">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari Kategori Staff..." value="{{ request('search') }}">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @forelse($kategoriStaffs as $item)
                                        <tr>
                                            ...
                                            <td class="">
                                                <a href="{{ route('kategoristaff.edit', $item->id) }}"
                                                    class="btn btn-success btn-sm"
                                                    style="width: 30px; height: 30px; padding: 0;">
                                                    <i class="bi bi-pencil-square" style="font-size: 18px;"></i>
                                                </a>
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    style="width: 30px; height: 30px; padding: 0;" data-bs-toggle="modal"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>Apakah Anda yakin ingin menghapus Kategori Staff ini?
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer justify-content-center">
                                                                <form
                                                                    action="{{ route('kategoristaff.destroy', $item->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                            ...
                            <div class="d-flex justify-content-end mt-3 ">
                                {{ $kategoriStaffs->onEachSide(1)->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
