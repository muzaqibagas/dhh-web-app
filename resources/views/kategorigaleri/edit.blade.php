    ...
    <main class="content">
        <div class="container-fluid mt-4">
            <div class="adm-header">
                <h2 class="adm-title text-dark">Edit Kategori Galeri</h2>
            </div>
            @if (session('info'))
                    ...
                    <div class="table-responsive">
                        <form action="{{ route('kategorigaleri.update', $kategoriGaleri->id) }}" method="POST">
                            ...
                            <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nama" value="{{ $kategoriGaleri->nama }}"
                                        class="form-control" id="kategori" placeholder="Kategori Galeri..." required>
                                </div>
                            </div>
                            <!-- Tombol -->
                            <div class="row mt-4">
