                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" placeholder="Masukkan Nama Lengkap"
                            value="{{ old('nama', $seminarmhs->nama) }}" readonly required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nim" placeholder="Masukkan NIM"
                            value="{{ old('nim', $seminarmhs->nim) }}" readonly required>
                    </div>

                    <div class="form-group">
                        <label>Semester</label>
                        <input type="text" value="{{ $seminarmhs->semester->semester }}" placeholder="Masukkan Semester"
                            readonly required>
                    </div>

                    <div class="form-group">
                        <label>Alamat di Bogor</label>
                        <input type="text" value="{{ $seminarmhs->alamat ?? '-' }}"
                            placeholder="Masukkan Alamat Lengkap" readonly required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" value="{{ \Carbon\Carbon::parse($seminarmhs->tanggal)->format('Y-m-d') }}"
                            readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <input type="text" class="w-25"
                                value="{{ \Carbon\Carbon::parse($seminarmhs->waktu_mulai)->format('H:i') }}" readonly>
                            <p class="m-0">S/D</p>
                            <input type="text" class="w-25"
                                value="{{ \Carbon\Carbon::parse($seminarmhs->waktu_selesai)->format('H:i') }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="text-success fw-bold"
                            value="{{ $seminarmhs->syaratUjianSeminar?->moderator?->nama ?? '[Diisi oleh akademik]' }}"
                            readonly>
                    </div>
