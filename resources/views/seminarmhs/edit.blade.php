                ...
                <form action="{{ route('seminarmhs.update', $seminarmhs->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" placeholder="Masukkan Nama Lengkap"
                            value="{{ old('nama', $seminarmhs->nama) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nim" placeholder="Masukkan NIM"
                            value="{{ old('nim', $seminarmhs->nim) }}" required>
                    </div>
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-3">
                                <input type="time" id="waktu_mulai" name="waktu_mulai" min="08:00" max="16:00"
                                    value="{{ old('waktu_mulai', $seminarmhs->waktu_mulai ? \Carbon\Carbon::parse($seminarmhs->waktu_mulai)->format('H:i') : '') }}"
                                    required>
                                <p class="m-0">S/D</p>
                                <input type="time" id="waktu_selesai" name="waktu_selesai" min="08:00"
                                    max="16:00"
                                    value="{{ old('waktu_selesai', $seminarmhs->waktu_selesai ? \Carbon\Carbon::parse($seminarmhs->waktu_selesai)->format('H:i') : '') }}"
                                    required>
                            </div>
                            <small id="waktu-error" style="color:red;display:none;">Waktu Seminar Hasil tidak boleh pada
                                jam istirahat (12:00 - 13:00).</small>
                            @error('waktu_mulai')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            @error('waktu_selesai')
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipe" name="tipe_pelaksanaan" required>
                            <option value="offline"
                                {{ old('tipe_pelaksanaan', $seminarmhs->tipe_pelaksanaan) == 'offline' ? 'selected' : '' }}>
                                Offline</option>
                            <option value="online"
                                {{ old('tipe_pelaksanaan', $seminarmhs->tipe_pelaksanaan) == 'online' ? 'selected' : '' }}>
                    ...
                    <div class="form-group" id="ruangan-field">
                        ...
                        <select name="id_ruangan" id="id_ruangan"
                            {{ old('tipe_pelaksanaan', $seminarmhs->tipe_pelaksanaan) == 'offline' ? 'required' : '' }}>
                    ...
                    <div class="form-group d-none" id="link-field">
                        ...
                        <input type="url" name="link_meeting" id="link_meeting" placeholder="https://zoom.us/..."
                            value="{{ old('link_meeting', $seminarmhs->link_meeting) }}"
                            {{ old('tipe_pelaksanaan', $seminarmhs->tipe_pelaksanaan) == 'online' ? 'required' : '' }}>
                        @error('link_meeting')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="text-success fw-bold"
                            value="{{ $seminarmhs->syaratSeminar->moderator->nama ?? '[Diisi oleh akademik]' }}" readonly>
                    </div>
