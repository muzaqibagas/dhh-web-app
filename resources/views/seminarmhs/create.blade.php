                ...
                <form action="{{ route('seminarmhs.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" placeholder="Masukkan Nama Lengkap"
                            value="{{ Auth::user()->nama ?? 'Guest' }}" required readonly>
                        <input type="hidden" name="id_mahasiswa" value="{{ Auth::id() }}">
                    </div>

                    <div class="form-group">
                        <label>NIM</label>
                        <input type="text" name="nim" placeholder="Masukkan NIM" value="{{ Auth::user()->nim }}"
                            required readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat" placeholder="Masukkan Alamat Lengkap" value=""
                            required>
                    </div>
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <input type="time" id="waktu_selesai" name="waktu_selesai" min="08:00"
                                    max="16:00" value="{{ old('waktu_selesai') }}" required>
                            </div>
                            <small id="waktu-error" style="color:red;display:none;">Waktu Seminar tidak boleh pada jam
