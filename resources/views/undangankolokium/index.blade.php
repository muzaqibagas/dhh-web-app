            ...
            <form action="#" method="POST">
                ...
                @php
                    $formFields = [
                        ...
                        'Tempat Kolokium' => '<input type="text" class="text-start form-control form-control-sm" placeholder="Masukkan tempat kolokium">',
