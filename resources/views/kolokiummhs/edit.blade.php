                ...
                <form action="{{ route('kolokiummhs.update', $kolokiummhs->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" placeholder="Masukkan Nama Lengkap..."
                            value="{{ old('nama', $kolokiummhs->nama) }}" required readonly>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nim" placeholder="Masukkan NIM..."
                            value="{{ old('nim', $kolokiummhs->nim) }}" required readonly>
                        @error('nim')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-3">
                                <input type="time" id="waktu_mulai" name="waktu_mulai" min="08:00" max="16:00"
                                    value="{{ old('waktu_mulai', $kolokiummhs->waktu_mulai ? \Carbon\Carbon::parse($kolokiummhs->waktu_mulai)->format('H:i') : '') }}"
                                    required>
                                <p class="m-0">S/D</p>
                                <input type="time" id="waktu_selesai" name="waktu_selesai" min="08:00"
                                    max="16:00"
                                    value="{{ old('waktu_selesai', $kolokiummhs->waktu_selesai ? \Carbon\Carbon::parse($kolokiummhs->waktu_selesai)->format('H:i') : '') }}"
                                    required>
                            </div>
                            <small id="waktu-error" style="color:red;display:none;">Waktu Kolokium tidak boleh pada jam
                                istirahat (12:00 - 13:00).</small>
                            @error('waktu_mulai')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            @error('waktu_selesai')
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipe" name="tipe_pelaksanaan" required>
                            <option value="offline"
                                {{ old('tipe_pelaksanaan', $kolokiummhs->tipe_pelaksanaan) == 'offline' ? 'selected' : '' }}>
                                Offline</option>
                            <option value="online"
                                {{ old('tipe_pelaksanaan', $kolokiummhs->tipe_pelaksanaan) == 'online' ? 'selected' : '' }}>
                                Online (Zoom/Meet)</option>
                        </select>
                    ...
                    <div class="form-group" id="ruangan-field">
                        ...
                        <select name="id_ruangan" id="id_ruangan"
                            {{ old('tipe_pelaksanaan', $kolokiummhs->tipe_pelaksanaan) == 'offline' ? 'required' : '' }}>
                    ...
                    <div class="form-group d-none" id="link-field">
                        ...
                        <input type="url" name="link_meeting" id="link_meeting" placeholder="https://zoom.us/..."
                            value="{{ old('link_meeting', $kolokiummhs->link_meeting) }}"
                            {{ old('tipe_pelaksanaan', $kolokiummhs->tipe_pelaksanaan) == 'online' ? 'required' : '' }}>
                        @error('link_meeting')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="text-success fw-bold"
                            value="{{ $kolokiummhs->syaratKolokium->moderator->nama ?? '[Diisi oleh akademik]' }}"
                            readonly>
                    </div>
