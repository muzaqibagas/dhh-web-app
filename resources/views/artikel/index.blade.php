        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Daftar Artikel</h2>
                                ...
                                <tbody>
                                    @forelse($artikels as $index => $artikel)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($artikel->foto)
                                                    <img src="{{ asset($artikel->foto) }}" alt="foto"
                                                        class="img-thumbnail"
                                            ...
                                            <td class="text-center">
                                                <div style="display: flex; justify-content: center; gap: 6px;">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#hapusModal{{ $artikel->id }}">
                                                        <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                    </button>
                                                    <div class="modal fade" id="hapusModal{{ $artikel->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Apakah Anda yakin ingin menghapus Artikel ini?
                                                                    </div>
                                                                </div>
