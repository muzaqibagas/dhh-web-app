        ...
        <main class="content">
            <div class="container-fluid">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Edit Data Artikel</h2>
                </div>
                @if (session('info'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="judul" id="judul"
                                                value="{{ old('judul', $artikel->judul) }}" placeholder="Judul.."
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-start row row-cols-1 row-cols-sm-2 align-items-center mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="id_kategoriartikel" class="form-select" id="kategori"
                                                required>
                                                <option value="">Pilih kategori</option>
                                                @foreach ($kategoriartikel as $kategori)
                                                    <option value="{{ $kategori->id }}"
                                                        {{ $artikel->id_kategoriartikel == $kategori->id ? 'selected' : '' }}>
                                                        {{ $kategori->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-lg-4 text-center mb-3">
                                    ...
                                    <div id="preview-container"
                                        ...
                                        <i id="preview-icon" class="bi bi-card-image fs-1 text-muted"
                                            @if ($artikel->foto) style="display:none;" @endif></i>
                                        <img id="preview-image" src="{{ $artikel->foto ? asset($artikel->foto) : '' }}"
                                            class="img-fluid rounded @if (!$artikel->foto) d-none @endif"
