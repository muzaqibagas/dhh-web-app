        ...
        <main class="content">
            <div class="kolokium-card">
                ...
                <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="nama" value="{{ old('nama', $komprehensifmhs->nama) }}" readonly
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" value="{{ \Carbon\Carbon::parse($komprehensifmhs->tanggal)->format('Y-m-d') }}"
                        readonly>
                </div>
                <div class="form-group">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <input type="text" class="w-25"
                            value="{{ \Carbon\Carbon::parse($komprehensifmhs->waktu_mulai)->format('H:i') }}" readonly>
                        <p class="m-0">S/D</p>
                        <input type="text" class="w-25"
                            value="{{ \Carbon\Carbon::parse($komprehensifmhs->waktu_selesai)->format('H:i') }}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label>Tempat Sidang</label>
                    <input type="text" class="text-success fw-bold"
                        value="{{ $komprehensifmhs->syaratUjianKomprehensif?->ruangan ?? '[Diisi oleh akademik]' }}"
                        readonly>
                </div>
                <div class="form-group">
                    <label>Ketua Sidang</label>
                    <input type="text" class="text-success fw-bold"
                        value="{{ $komprehensifmhs->syaratUjianKomprehensif?->moderator?->nama ?? '[Diisi oleh akademik]' }}"
                        readonly>
                </div>
                <div class="form-group">
                    <label>Dosen Penguji</label>
                    <input type="text" class="text-success fw-bold"
                        value="{{ $komprehensifmhs->syaratUjianKomprehensif?->penguji?->nama ?? '[Diisi oleh akademik]' }}"
                        readonly>
                </div>
                <div class="form-actions mt-3 d-flex justify-content-end">
                    ...
                    <a href="{{ route('komprehensifmhs.pdf', $komprehensifmhs->id) }}" class="btn btn-primary">Download
                        PDF</a>
                </div>
            </div>
        </main>
