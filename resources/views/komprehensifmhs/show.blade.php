...
<div class="main-container">
    ...
    <main class="content">
      ...
      <div class="form-group">
        ...
        <input type="text" class="text-success fw-bold" value="{{ $komprehensifmhs->syaratUjianKomprehensif?->ruangan ?? '[Diisi oleh akademik]' }}" readonly>						
			</div>  
			<div class="form-group">
				<label>Ketua Sidang</label>
				<input type="text" class="text-success fw-bold" value="{{ $komprehensifmhs->syaratUjianKomprehensif?->moderator?->nama ?? '[Diisi oleh akademik]' }}" readonly>				
			</div>
			<div class="form-group">
				<label>Dosen Penguji</label>
				<input type="text" class="text-success fw-bold" value="{{ $komprehensifmhs->syaratUjianKomprehensif?->penguji?->nama ?? '[Diisi oleh akademik]' }}" readonly>				
			</div>
