        ...
        <main class="content">
            <div class="container-fluid mt-4">
                <div class="adm-header">
                    <h2 class="adm-title text-dark mb-0">Daftar Galeri</h2>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($galeri->tipe == 'gambar' && $galeri->gambar)
                                                    <img src="{{ asset($galeri->gambar) }}" alt="foto"
                                                        class="img-thumbnail"
                                                ...
                                                @elseif($galeri->tipe == 'video')
                                                    @if (Str::startsWith($galeri->video, ['http', 'https']))
                                                        ...
                                                        @endphp
                                                        @if ($youtubeId)
                                                            <iframe width="80" height="45"
                                                                src="https://www.youtube.com/embed/{{ $youtubeId }}"
                                                                frameborder="0" allowfullscreen></iframe>
                                                        @else
                                                            <a href="{{ $galeri->video }}" target="_blank">Lihat
                                                                Video</a>
                                                        @endif
                                                    @else
                                                        <video src="{{ asset($galeri->video) }}" controls
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    ...
                                                    data-bs-target="#hapusModal{{ $galeri->id }}">
                                                    <i class="bi bi-trash" style="font-size: 18px;"></i>
                                                </button>
                                                <div class="modal fade" id="hapusModal{{ $galeri->id }}"
                            ...
                            <div class="d-flex justify-content-end mt-3 ">
                                {{ $galeris->onEachSide(1)->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
